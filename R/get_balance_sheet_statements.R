...
#'
#' This function retrieves the balance sheet statements for a specified stock
#' symbol from the Financial Modeling Prep (FMP) API.
#'
...
get_balance_sheet_statements <- function(
  ...
  balance_sheet_statements_raw <- perform_request(
